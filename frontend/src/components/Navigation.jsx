                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <Link to="/" className="flex items-center justify-start flex-shrink-0 -my-10 md:-my-12 -ml-4 md:-ml-6">
                        ...
                        <div className="hidden items-center gap-2">
                            ...
                            <span className="text-gray-900 text-xl font-bold">DEVGet Learning</span>
                        </div>
                    </Link>
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        <Link
                            to="/"
                            className={`${currentPage === 'home' ? 'text-accent-600 font-semibold' : 'text-gray-700'} hover:text-accent-600 transition-colors`}
                        >
                            Home
                        </Link>
                        <Link
                            to="/about"
                            className={`${currentPage === 'about' ? 'text-accent-600 font-semibold' : 'text-gray-700'} hover:text-accent-600 transition-colors`}
                        >
                            About
                        </Link>
                        ...
                        <div className="relative">
                            <button
                                ...
                                className={`flex items-center gap-1 ${currentPage === 'resources' ? 'text-accent-600 font-semibold' : 'text-gray-700'} hover:text-accent-600 transition-colors`}
                            >
                                Resources
                        ...
                        <Link
                            to="/contact"
                            className={`${currentPage === 'contact' ? 'text-accent-600 font-semibold' : 'text-gray-700'} hover:text-accent-600 transition-colors`}
                        >
                            Contact
                        </Link>
                    </div>
                ...
                {mobileMenuOpen && (
                    <div className="md:hidden py-4 border-t border-gray-200 bg-white">
                        <div className="flex flex-col space-y-3">
                            <Link to="/" className="px-4 py-2 text-gray-900 font-medium" onClick={() => setMobileMenuOpen(false)}>
                                Home
                            </Link>
